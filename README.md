...
## Notes on the data
The maintenance schedule uses **official Mazda 3 SkyActiv intervals adjusted for Saudi "severe" conditions** (heat/dust), e.g. engine oil every 5,000 km / 6 months. Every number — intervals, last-service points, costs, parts, prices, stores — can be edited from within the app. Odometer defaults to 155,000 km.
