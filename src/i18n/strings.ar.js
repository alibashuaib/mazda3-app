...
const AR = {
  ...
  'Community price': 'سعر المجتمع', 'reports': 'تقييم', 'No reports yet': 'لا توجد تقييمات بعد', 'Report your price': 'شارك سعرك', 'Search or add an item…': 'ابحث أو أضف عنصراً…', 'Add "%s" as a new item': 'أضف "%s" كعنصر جديد', 'Your price (SAR)': 'سعرك (ريال)', 'Submit price': 'إرسال السعر', 'Price submitted ✓': 'تم إرسال السعر ✓', 'Sign in to see or share community prices.': 'سجّل الدخول لعرض أو مشاركة أسعار المجتمع.', 'Price required': 'السعر مطلوب',
  // report types
