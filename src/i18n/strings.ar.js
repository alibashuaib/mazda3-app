...
const AR = {
  ...
  'Community (tighter)': 'المجتمع (أقصر)', 'Dealer (10,000 km)': 'الوكيل (10,000 كم)', 'Dealer': 'استخدام وكالة', 'Community': 'المجتمع', 'Severe': 'استخدام شاق',
  ...
  // milestone plan
  'Plan': 'الخطة', 'Major milestone': 'صيانة دورية كبرى', 'mo': 'شهر', 'yr': 'سنة', 'Next up': 'التالي',
  'What’s coming up, built from your own services and when each was last done. Tap a task to log it, or log a whole milestone.': 'ما هو قادم، مبني من خدماتك ومتى أُجريت كل منها آخر مرة. اضغط على مهمة لتسجيلها، أو سجّل صيانة دورية كاملة.',
  'Log this milestone': 'سجّل هذه الصيانة الدورية', 'Milestone logged ✓': 'تم تسجيل الصيانة الدورية ✓', 'Milestone': 'صيانة دورية',
  'Show later years': 'عرض السنوات القادمة', 'Nothing scheduled — you’re all caught up!': 'لا شيء مجدول — كل شيء عندك تمام!',
  ...
  'Set up your plan': 'إعداد خطة الصيانة', 'Set up': 'إعداد', 'e.g. 316,000': 'مثال: 316,000',
  ...
  'All': 'الكل', 'OK': 'سليمة',
  // buttons
  'Log a service': 'تسجيل صيانة', 'Add spending': 'إضافة مصروف', 'Add fill-up': 'إضافة تعبئة', 'Mark done now': 'تحديد كمنجز',
  'A single service, or a whole milestone at once.': 'صيانة واحدة، أو صيانة دورية كاملة دفعة واحدة.',
  'Single service': 'صيانة', 'Pick one thing you just had done.': 'اختر شيئاً واحداً أنجزته للتو.', 'Choose': 'اختيار',
  'A group of services from your plan, done together.': 'مجموعة صيانات من خطتك، أُنجزت معاً.',
  'Log a milestone': 'تسجيل صيانة دورية', 'Pick an upcoming milestone — logs everything in it at once.': 'اختر صيانة دورية قادمة — يسجّل كل ما فيها دفعة واحدة.',
  ...
  'Done': 'تمّت', 'Not yet': 'ليس بعد', 'Carried to your next milestone': 'مُرحّلة إلى صيانتك الدورية القادمة',
  // add-vehicle picker
  ...
  'Throttle Body & MAF Cleaning': 'تنظيف بوابة الهواء وحساس الهواء', 'Spark Plugs (x4)': 'بواجي الإشعال (×4)', 'Spark Plugs (x6)': 'بواجي الإشعال (×6)', 'Fuel Filter': 'فلتر الوقود',
  ...
  'Drivetrain': 'نقل الحركة', 'Suspension': 'التعليق', 'A/C': 'التكييف', 'Tires': 'الإطارات', 'General': 'عام', 'Paint': 'الدهان',
  ...
  'Add spending ': 'إضافة مصروف', 'Edit expense': 'تعديل المصروف', 'Log a service ': 'تسجيل صيانة', 'Annual budget': 'الميزانية السنوية',
  // common field labels
  ...
  'DOT 3/4 (~1 L). Absorbs moisture over time — flush every 2 years.': 'DOT 3/4 (~1 لتر). يمتص الرطوبة مع الوقت — فلّشه كل سنتين.',
  ...
  'Clean throttle body & MAF sensor — Jeddah dust fouls them; restores idle & economy. (Known BM Mazda 3 MAF failure point.)': 'نظّف بوابة الخانق وحساس MAF — غبار جدة يلوّثهما؛ يثبّت الاستاندر ويحسّن استهلاك الوقود. (نقطة ضعف معروفة في حساس MAF لموديل BM من مازدا 3.)',
  'Iridium NGK ILKAR7L11 — every 120,000 km / 6 yr (Except-Europe schedule). Restores smooth idle & economy.': 'بواجي NGK إيريديوم ILKAR7L11 — كل 120,000 كم / 6 سنوات (جدول خارج أوروبا). يثبّت الاستاندر ويحسّن استهلاك الوقود.',
  ...
  'Vibration/clunk on start, idle or acceleration = worn mount': 'اهتزاز/طرقعة عند التشغيل أو الاستاندر أو التسارع = قاعدة محرك تالفة',
